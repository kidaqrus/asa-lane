...
const Home = () => {
  ...
  const copyText = () => {
    ...
    textField.innerText = 'asablog@gmail.com';
  ...
  return (
    <Layout>
      <PageSection color={color}>
        <PageWrapper>
          <article>
            <h1 data-text="My Name Is Ahmed Sule" className="intro__text">
              <mark className="mark">my&apos;name is Ahmed Sule</mark>
            </h1>
            <p>
              {' '}
              FullStack developer who loves everything 'bout the web,{' '}
              {' '}
               practicing React, and{' '}
              everything bout the internet{' '}
              in search of flow.
            </p>
            <p>
